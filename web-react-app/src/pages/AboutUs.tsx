    ...
    return (
        <div>
            <div className="content">
                <div className="contenido-about-us">
                <p> En Gatos Unidos, somos un grupo de amantes de los gatos comprometidos con su bienestar. Desde siempre, los gatos han sido parte de nuestras vidas, y con el tiempo, nuestra pasión por ayudarles nos llevó a emprender este proyecto. </p>
                    ...
                    <p> Si ves un gato que necesita ayuda, contáctanos a través de nuestro formulario. Juntos, podemos marcar la diferencia en sus vidas. </p>
                </div>
            </div>
        </div>
    );
